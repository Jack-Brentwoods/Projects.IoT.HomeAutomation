...
const routes = require('./src/routes/sensor.routes');
const sensorModel = require('./src/models/sensors.model');
const cors = require('cors');
app.use(cors({ origin: '*' })); // Mở CORS cho tất cả
...
// MQTT setup
const mqttClient = mqtt.connect('mqtt://192.168.1.140:1883'); // Use your MQTT broker address
...
mqttClient.on('message', async (topic, message) => {
    ...
    // listen to other subscribed topics
    // if (topic == x) {}
});
